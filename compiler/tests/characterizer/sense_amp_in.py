...
class SenseAmpIn(CharTestBase):
    ...
    def runTest(self):
        ...
        load = sense_amp_array(word_size=cols, words_per_row=1)

        self.load_pex = self.run_pex_extraction(load, "sense_amp")
        ...
        for pin in ["en", "en_bar"]:
            ...
            dut_instance += " vdd gnd sense_amp_array \n"
