...
class DecoderLogic(BitcellVerticalAligned):
    ...
    def route_layout(self):
        ...
        for row in range(self.num_rows):
            for i in range(2):
                ...
                self.route_en_0_nand_output(row)
                self.route_en_1_nand_output(row, fill_width, fill_height)

    def route_en_0_nand_output(self, row):
    ...
    def route_en_1_nand_output(self, row, fill_width, fill_height):
    ...
    def add_body_taps(self):
        self._add_body_taps(self.en_1_insts[0], self.en_1_insts)
